      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              title,
              style: TextStyle(fontSize: 20, color: ColorConstraints.mainblack,fontWeight: FontWeight.bold),
            ),
            SizedBox(height: 10,),
            Visibility(
                  ...
                  child: Row(
                    ...
                    Stack(
                        children: [
                          ...
                          Visibility(
                            visible: secondaryImageVisible,
                            child: Positioned(
                              bottom: 0,
                              right: 0,
                              child: CircleAvatar(
                                radius: 8,
                                backgroundImage: chat["secondaryImage"] != null
                                    ? NetworkImage(chat["secondaryImage"])
                                    : null,
                              ),
                            ),
                          ),
